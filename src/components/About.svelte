<script lang="ts">
    export let about: boolean;
    export let setAbout: () => void;
</script>

{#if about}
 <div id="aboutBox">
        <button type="button" id="closeAbout" on:click={setAbout}>
          X
        </button>
        <p>
          Made by{' '}
